                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                       ...
                       <ul id="@@singular@@SubMenu" class="collapse">
                       		<li><a href="{{url('/admin/@@plural@@/create')}}"><i class="fa fa-fw fa-plus"></i> Create</a></li>
                       		<li><a href="{{url('/admin/@@plural@@/view')}}"><i class="fa fa-fw fa-eye"></i> View</a></li>
                       		<li><a href="{{route('adminConfig@@singular-pascalCase@@')}}"><i class="fa fa-fw fa-wrench"></i> Config</a></li>
                       </ul>
                    </li>
                    <li>
                    ...
                    <li>
                       ...
                       <ul id="configSubMenu" class="collapse">
                       		...
                       		<li><a href="{{ route('adminConfig@@singular-pascalCase@@') }}"><i class="fa fa-fw fa-wrench"></i> @@singular-pascalCase@@ Config</a></li>
                       </ul>
                    </li>
                    <li>
                    ...
                    <li>
                       ...
                       <ul id="pagesSubMenu" class="collapse">
                       		<li><a href="{{url('/admin/pages/create')}}"><i class="fa fa-fw fa-plus"></i> Create</a></li>
                       		<li><a href="{{url('/admin/pages/view')}}"><i class="fa fa-fw fa-eye"></i> View</a></li>
                       </ul>
                    </li>
