...
class ShortCodeEngine {
    ...
    /*Adapted from WordPress: https://core.trac.wordpress.org/browser/tags/3.5.1/wp-includes/shortcodes.php*/

    public $shortCodeTags = array();

    /*
     * Load shortcodes and their handler functions
     * @param $shortCodes keymap of shortcodes and their handler functions
    */
    public function loadShortCodes($shortCodes) {
       $this->shortCodeTags = $shortCodes;
    }
